...
def optimize(tau, kappa, key):
    ...
    op = FleetSizeOptimizer(flight_time=tau, energy_consumption=kappa, schedule='schedule_5min_1000pax_0713.csv', time_step=1)
    op.optimize(f'wind_variation_1000pax_1min/{distance_key}_{wind_direction_key}_{wind_magnitude_key}_.txt', 
...
if __name__ == '__main__':
    ...
    directory_path = f"output/wind_variation_1000pax_1min"  # Replace with the path to your directory
